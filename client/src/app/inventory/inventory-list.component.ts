...
export class InventoryListComponent {
  ...
  inventoryQuantity = signal<number | undefined>(undefined);
  inventoryItem = signal<string | undefined>(undefined);
  inventoryProperties = signal<string | undefined>(undefined);
  ...
  private inventoryItem$ = toObservable(this.inventoryItem);
  private inventoryQuantity$ = toObservable(this.inventoryQuantity);
  ...
  serverFilteredInventories =
    ...
    toSignal(
      combineLatest([this.inventoryItem$, this.inventoryQuantity$]).pipe(
